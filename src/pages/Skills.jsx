      ...
      <div className="container">
        ...
        >
          {skillsData.map((skill) => (
            <motion.li
              key={skill.id}
              className={`select-none bg-gradient-to-r from-sky-400  to-gray-300 border border-gray-950 rounded-2xl px-3.5 py-2.5 md:px-4 md:py-3 lg:px-5 lg:py-4${
              ...
              whileTap={{ scale: 1.1, transition: { duration: 0.2 } }} // Simulates a press effect
            >
